...
namespace Spa
{
    public partial class frmPantallaAdmin : Form
    {
        ...
        {
            frmSiNo chau = new frmSiNo("Estas seguro que quieres cerrar el programa?");
        ...
        private void btnCerrarSesion_Click_1(object sender, EventArgs e)
        {
            ...
            frmSiNo chau = new frmSiNo("Estas seguro que quieres cerrar sesión?");
            if(chau.ShowDialog()== DialogResult.OK)
            {
                this.Hide();
        ...
        private void btnCapacidadesYCupos_Click(object sender, EventArgs e)
        {
            if (CurrentButton != btnCapacidadesYCupos)
            {
                ...
                this.pnlCargado.Controls.Clear();
                frmCapacidadesYCupos frmInicio_carga = new frmCapacidadesYCupos("Admin")
                {
                    Dock = DockStyle.Fill,
                    TopLevel = false,
                    TopMost = true
        ...
        private void btnTransporte_Click(object sender, EventArgs e)
        {
            if (CurrentButton != btnTransporte)
            {
                ...
                this.pnlCargado.Controls.Clear();
                frmTransporte frmInicio_carga = new frmTransporte("Admin")
                {
                    Dock = DockStyle.Fill,
                    TopLevel = false,
                    TopMost = true
